...
import { TechnicalIndicators } from '../../types/stock-data';
 ...
 */
export function findSupportResistance(priceData: PricePoint[], lookback: number = 20): {
  support: number[];
  resistance: number[];
} {
 ...
 */
export function calculateAllIndicators(priceData: PricePoint[]): TechnicalIndicators {
 ...
 */
export function interpretTechnicalIndicators(indicators: TechnicalIndicators, currentPrice: number): {
  signals: string[];
