 ...
 */
function getMarketContext(market: 'US' | 'INDIA'): string {
  if (market === 'INDIA') {
    return `
 ...
 */
export function getAgentDefinitions(market: 'US' | 'INDIA' = 'INDIA'): AgentDefinition[] {
 ...
 * Get agents by role
 */
export function getAgentsByRole(role: AgentDefinition['role'], market: 'US' | 'INDIA' = 'INDIA'): AgentDefinition[] {
 ...
 * Get agent by ID
 */
export function getAgentById(id: string, market: 'US' | 'INDIA' = 'INDIA'): AgentDefinition | undefined {
