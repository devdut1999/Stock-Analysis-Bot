 ...
 */
import { detectMarket } from './market-detector.js';
import { getIndianStockQuote, getIndianHistoricalData, getIndianFundamentals } from '../tools/market-data/indian-api.js';
import { getYahooQuote, getYahooHistoricalData, getYahooFundamentals } from '../tools/market-data/yahoo-finance.js';
import { getFIIDIIActivity } from '../tools/india-specific/fii-dii.js';
import { getPromoterHolding, analyzePromoterHolding } from '../tools/india-specific/promoter.js';
import { getScreenerCompanyData } from '../tools/india-specific/screener.js';
import { getFnOData } from '../tools/india-specific/fno-data.js';
import { calculateAllIndicators, interpretTechnicalIndicators } from '../tools/technical/indicators.js';
/**
 * Collect all available data for a stock symbol
 */
export async function collectStockData(symbol, options = {}) {
    const { includeFundamentals = true, includeTechnicals = true, includeIndiaSpecific = true, historicalDays = 90 } = options;
    // Detect market
    ...
    try {
        ...
        if (includeIndiaSpecific) {
            ...
            const [fiiDiiData, screenerData, fnoData] = await Promise.all([
...
//# sourceMappingURL=intelligence-hub.js.map