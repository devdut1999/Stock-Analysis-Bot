 ...
 */
export async function getIndianStockQuote(symbol, exchange = 'NSE') {
 ...
 */
export async function getIndianHistoricalData(symbol, exchange = 'NSE', days = 30) {
    await rateLimiter.waitForSlot('indianStockAPI');
    try {
 ...
 */
export async function getIndianFundamentals(symbol, exchange = 'NSE') {
    await rateLimiter.waitForSlot('indianStockAPI');
    try {
...
//# sourceMappingURL=indian-api.js.map